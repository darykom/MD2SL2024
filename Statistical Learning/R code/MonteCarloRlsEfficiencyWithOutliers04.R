...
for (N in Ntests)
{
   ...
   fname = paste0('./Figs/McEfficencyTestOutliers04Ls', 'N', N, '.pdf')
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04Lmeds', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04Lms', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04LsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04LmedsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04LmsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers04LsRLs', 'N', N, '.pdf')
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers04LmedsRLs', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=3.5,height=3.5)
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers04LmsRLs', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=3.5,height=3.5)
...
#.........................................................................
   # estremi assi istogrammi "wider"
   bmin0 = -5.0;  bmax0 =  11.0 #bmin0 = -3;    bmax0 =  5
   bmin1 = -3.0;  bmax1 =   1.0 #bmin1 = -0.5;  bmax1 =  1.5
   #ymax0 = 3; ymax1 = 12
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04WideLs', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   PlotHist_b0b1(estLS,
                 b0,b1,
                 colbar=lightYellow,
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04WideLmeds', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   PlotHist_b0b1(estLMedS,
                 b0,b1,
                 colbar=lightOrange,
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04WideLms', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   PlotHist_b0b1(estLMS,
                 b0,b1,
                 colbar=lightPink,
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04WideLsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   PlotHist_b0b1(estLsRLS,
                 b0,b1,
                 colbar=lightYellow,
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04WideLmedsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   PlotHist_b0b1(estLmedsRLS,
                 b0,b1,
                 colbar=lightGreen,
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers04WideLmsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   PlotHist_b0b1(estLmsRLS,
                 b0,b1,
                 colbar=lightBrown,
