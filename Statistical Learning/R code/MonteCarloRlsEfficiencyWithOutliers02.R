...
for (N in Ntests)
{
   ...
   fname = paste0('./Figs/McEfficencyTestOutliers02Ls', 'N', N, '.pdf')
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers02Lmeds', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers02Lms', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers02LsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers02LmedsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers02LmsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers02LsRLs', 'N', N, '.pdf')
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers02LmedsRLs', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=3.5,height=3.5)
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers02LmsRLs', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=3.5,height=3.5)
