...
for (N in Ntests)
{
   ...
   #set.seed(111) superfluo
   cat('Generating ', nsim, 'trials\n')
   allData = lapply(1:nsim, function(s){DGP_Outliers_b0b1(s, N,sigma_e, b0,b1, outperc, dgpUniformY, urange)}) 
   ...
   fname = paste0('./Figs/McEfficencyTestOutliers01Ls', 'N', N, '.pdf')
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers01Lmeds', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers01Lms', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers01LsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers01LmedsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   xlab0str = paste0("$sd(\\beta_0)=", sdb0, "$")
   xlab1str = paste0("$sd(\\beta_1)=", sdb1, "$")
   fname = paste0('./Figs/McEfficencyTestOutliers01LmsRls', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=5,height=3.4)
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers01LsRLs', 'N', N, '.pdf')
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers01LmedsRLs', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=3.5,height=3.5)
   ...
   fname = paste0('./Figs/McEfficencyTestSensSpecOutliers01LmsRLs', 'N', N, '.pdf')
   if (save2pdf) pdf(fname, width=3.5,height=3.5)
